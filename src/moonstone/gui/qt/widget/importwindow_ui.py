...
#
# Created: Thu May  2 14:54:31 2013
...
class Ui_ImportWindow(object):
    def setupUi(self, ImportWindow):
        ...
        self.gridLayout_3 = QtGui.QGridLayout(self.treeWidgetContainer)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.frame = QtGui.QFrame(self.treeWidgetContainer)
        ...
        self.treeWidget = QtGui.QTreeWidget(self.treeWidgetContainer)
    ...
    def retranslateUi(self, ImportWindow):
        ...
        self.treeWidget.headerItem().setText(0, QtGui.QApplication.translate("ImportWindow", "Name", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(1, QtGui.QApplication.translate("ImportWindow", "Sex", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(2, QtGui.QApplication.translate("ImportWindow", "Age", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(3, QtGui.QApplication.translate("ImportWindow", "Modality", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(4, QtGui.QApplication.translate("ImportWindow", "#Images", None, QtGui.QApplication.UnicodeUTF8))
